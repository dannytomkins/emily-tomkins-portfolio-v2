...
export type Settings = {
  ...
  menuItems?: Array<{
    ...
    route?: string
    reference?: HomeReference | PageReference | ProjectReference | WorkReference
    href?: string
...
// Query: *[_type == "home"][0]{    _id,    _type,    overview,    heroImage,    portraitImage,    showcaseProjects[]{      _key,      ...@->{        _id,        _type,        coverImage,        overview,        "slug": slug.current,        tags,        title,      }    },    title,  }
...
// Query: *[_type == "page" && slug.current == $slug][0] {    _id,    _type,    body,    overview,    title,    heroImage,    portraitImage,    "slug": slug.current,  }
...
// Query: *[_type == "settings"][0]{    _id,    _type,    footer,    ogImage,    menuItems[]{      _key,      title,      kind,      route,      href,      openInNewTab,      reference->{        _type,        title,        "slug": slug.current      }    }  }
export type SettingsQueryResult = {
  ...
  menuItems: Array<{
    _key: string
    title: string | null
    kind: 'external' | 'reference' | 'route' | null
    route: string | null
    href: string | null
